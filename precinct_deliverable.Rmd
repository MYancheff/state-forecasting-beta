...
* PARTY_CODE:the candidate's party affilation for observation *n*

* VOTES: the total number within precicnt *n* that votes for *y* PARTY_CODE and *X* officename
...
```{r 1992-2002 Bind Carson City, Clark and Washoe County dfs}
