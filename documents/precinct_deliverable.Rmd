...
* PARTY_CODE: the candidate's party affiliation for the current election

* VOTES: the total number within precinct *n* that votes for *y* PARTY_CODE and *X* officename
...
```{r 1984-1990, eval= FALSE}
#Import FIPS County_Code Data
FIPS_County_Code <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/FIPS County Code.xlsx")
...
```{r 1992-2002 Clark County, eval= FALSE}
#Import the 1992-2002 Clark County Data, converted into machine-readable format
nvclark1992to2002 <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/nvclark1992to2002.xls")

#Import precinct-to-district cheatsheets
  #1992-1994
CLARK_COUNTY_1992_1994_ASSEMBLY_DISTRICT <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/CLARK COUNTY 1992-1994 ASSEMBLY DISTRICT.xlsx")
CLARK_COUNTY_1992_1994_SENATE_DISTRICT <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/CLARK COUNTY 1992-1994 SENATE DISTRICT.xlsx")
...
cheatsheet1992_1994CLARK <- CLARK_COUNTY_1992_1994_ASSEMBLY_DISTRICT %>%
  ...
  #1996-2000
CLARK_COUNTY_1996_2000_ASSEMBLY_DISTRICT <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/CLARK COUNTY 1996-2000 ASSEMBLY DISTRICT.xlsx")  
CLARK_COUNTY_1996_2000_SENATE_DISTRICT <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/CLARK COUNTY 1996-2000 SENATE DISTRICT.xlsx")
...
cheatsheet1996_2000CLARK <- CLARK_COUNTY_1996_2000_ASSEMBLY_DISTRICT %>%
  ...
  #2002
CLARK_COUNTY_2002_ASSEMBLY_DISTRICT <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/CLARK COUNTY 2002 ASSEMBLY DISTRICT.xlsx")
CLARK_COUNTY_2002_SENATE_DISTRICT <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/CLARK COUNTY 2002 SENATE DISTRICT.xlsx")
...
```{r 1992-2002 Carson City, eval= FALSE}

#Import Carson City Data
carsoncity1996to2002 <- read_excel("data-raw/state-legislative-data/Precinct Level Election Results/carsoncity1996to2002.xls")
...
```{r 1992-2002 Washoe County, eval= FALSE}
#Import the main Washoe precinct-level voting data from 1994-2002
washoe1994to2002 <- read_csv("data-raw/state-legislative-data/Precinct Level Election Results/washoe1994to2002.csv")
...
```{r 1992-2002 Bind Carson City, Clark and Washoe County dfs, eval= FALSE}
...
```{r precinct deliverable, eval= FALSE}
...
write.csv(precinct_deliverable, "data/Nevada_General_Election_Precinct_Level_Voting_Results_1984-2016.csv")
```
