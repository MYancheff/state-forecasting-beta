...
pres_summary = prec_level_data %>%
  group_by(Race,Year,DISTRICT_ID) %>%
...
tot_data = left_join(use_data,pres_summary,by=c("ELECTION_YEAR"="Year","Assembly"="ElectionType","DistrictID"="DISTRICT_ID")) %>%
