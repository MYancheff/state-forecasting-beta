...
plot_chart_use_data %>%
  mutate(assembly_composition = assembly_composition*0.5,
         dem_years = ifelse(assembly_composition > 0,assembly_composition,0),
         rep_years = ifelse(assembly_composition < 0,assembly_composition,0)) %>%
