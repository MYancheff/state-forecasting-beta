...
late_data = general_election_data %>%
  filter(IN_SENATE(SENATE_OR_HOUSE),
    ELECTION_YEAR >= 1992,ELECTION_YEAR < 2004)
       #!(ALT_DISTRICT_NAME %in% c("CLARK","CAPITAL","WASHOE","RURAL","CENTRAL")))
table(late_data$DISTRICT_NUM)
